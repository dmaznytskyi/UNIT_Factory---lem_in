...
/*   Updated: 2017/10/19 18:09:39 by dmaznyts         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define LEAK system("leaks $(echo $(ps | grep lem-in | cut -d ' ' -f 1) | cut -d ' ' -f 1) && leaks $(echo $(ps | grep lem-in | cut -d ' ' -f 1) | cut -d ' ' -f 2)");
